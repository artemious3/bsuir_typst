...
// ----------------------------------------------------------
// Данная функция выделяет все латинские буквы курсивом.
// Гриценко сказал, что ему всё равно, однако для СТП-2026,
// которое скоро выйдет, может пригодиться
//
// Пример использования: 
//
// ````
// #show: stp2024.italicize_latin
// ````
// ----------------------------------------------------------
#let italicize_latin(doc) = {
  show regex("[a-zA-Z]+"): it => emph(it)
  doc
}
